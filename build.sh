...
wait
ar rs libamd.a amd_l_aat.o amd_l_2.o amd_l_postorder.o amd_l_post_tree.o amd_l_defaults.o amd_l_valid.o
cd ../../COLAMD/Lib
...
wait
ar rs  libcholmod.a cholmod_l_aat.o cholmod_l_band.o cholmod_l_change_factor.o cholmod_l_common.o cholmod_l_copy.o \
...
wait
ar rs  libumfpack.a umf_l_analyze.o umf_l_apply_order.o umf_l_colamd.o umf_l_free.o umf_l_fsize.o umf_l_is_permutation.o umf_l_malloc.o umf_l_realloc.o \
